...
export function GamutPicker({
    ...
    return (
        <RadioGroup
            value={value}
            onChange={onChange}
            className="flex items-center justify-center gap-1 rounded border border-slate-700 p-0.5 text-sm text-slate-400"
        >
...
function GamutPickerOption({
    ...
    return (
        <RadioGroup.Option
            value={value}
            className="flex cursor-pointer items-center gap-2 rounded-sm py-0.5 px-3 hover:text-slate-300 ui-checked:bg-slate-700 ui-checked:text-slate-300"
